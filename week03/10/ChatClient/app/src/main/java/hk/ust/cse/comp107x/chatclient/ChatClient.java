...
public class ChatClient extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Create a new custom ArrayAdapter. This custom Adapter is implemented by us, and illustrates how an ArrayAdapter is constructed given the data (from the Message objects)
