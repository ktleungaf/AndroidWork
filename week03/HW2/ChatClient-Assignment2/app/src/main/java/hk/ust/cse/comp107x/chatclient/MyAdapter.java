...
public class MyAdapter extends ArrayAdapter<Message> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (messages.get(position).fromMe()) {
            ...
            //TODO
             // this message is from me so this message is the outgoing message to be displayed towards the right of the screen
            messageView = inflater.inflate(R.layout.mymessage, parent, false);
            TextView timeView = (TextView) messageView.findViewById(R.id.mymessageTextView);
            ...
            //TODO
            // this message is NOT from me so this message is the incoming message to be displayed towards the left of the screen
